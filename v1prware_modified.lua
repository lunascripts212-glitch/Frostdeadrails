...
------------------------------------------------------------------------
local secSK8 = tabAutoTrick:Section({ Title = "SK8 Control", Opened = true })
...
do
    ...
    -- Slider for dash speed
    local sk8_speedVal = cfg.get("sk8Speed", 60)
    ...
    secSK8:Slider({
        Title = "Charge Speed", Desc = "WalkSpeed during charge animation",
        Step = 5, Value = { Min = 20, Max = 120, Default = sk8_speedVal },
        Callback = function(v)
            sk8_DASH_SPEED = v
            cfg.set("sk8Speed", v)
        end
    ...
    secSK8:Paragraph({
        Title   = "How it works",
        Content = "Detects Veeronica's charge animation (ID 117058860640843) and forces forward movement at the set speed with shiftlock active. Automatically restores your original stats when the charge ends.",
    })
end
